...
Store reusable tool scripts, not temporary requests, raw outputs, or credentials.
...
Read this index before creating a duplicate tool.

## Tool index

Maintain the current tool index here.
