...
`kernel_agent_revision_id`, `changed_paths`, and `contributing_paths`. The second contains sorted paths relative to the selected visible Bundle, including all three adaptive
