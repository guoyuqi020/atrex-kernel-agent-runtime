...
Optimizer 可以修改 Kernel 源码以及自适应 `skills/`、`tools/`；Evolver 可以修改 Optimizer 的
源码、Workflow、Skill 与 Tool。但两者都不能修改 Registry、读取私有验证输入、为自己签发
...
- `skills/`、`tools/` 中的自适应 Runtime State。
